...
![Version](https://img.shields.io/badge/version-2.0.0-blue.svg) ![License](https://img.shields.io/badge/license-Proprietary-red.svg) ![Author](https://img.shields.io/badge/made%20by-NullC0d3-000000.svg)
...
- Secure random credential generation via `openssl rand`
- `.env` files created with `chmod 600`
- Avoids `eval` on untrusted input paths
...
Location: `~/.rabbithole/state.json`
